...
class Waiter:
    ...
    def antar_pesanan(self, pesanan: str) -> None:
        # menambahkan pesanan ke pesanan_diantar
        self.pesanan_diantar.append(pesanan) # menambahkan pesanan ke list pesanan_diantar
...
class Restoran:
   ...
   # class atribute
    ...
    def ubah_menu_cabang(self, menu_baru: list[str]) -> None:
        ...
        print(f"Menu cabang {self.nama_cabang} telah diubah menjadi:\n {'\n'.join(menu_baru)}")
...
class Karyawan:
    ...
    def __init__(self, nama: str, posisi: str, gaji_bulan: float, tahun_masuk: int) -> None:
        self.nama: str = nama
    ...
    '''
    @classmethod
    def dari_gaji_tahun(cls: Type["Karyawan"], nama: str, posisi: str, gaji_tahun: float, tahun_masuk: int) -> "Karyawan":
...
mobil = Mobil("Toyota", 200, "Merah")
mobil.start()
mobil.stop()

class Toyota(Mobil, Kendaraan):
    def __init__(self, seri: str, tahun: int) -> None:
        super().__init__("Toyota", 200, "Merah")
        self.seri: str = seri
        self.tahun: int = tahun

    def info(self) -> None:
        print('=======================')
        print(f"Seri: {self.seri}")
        print(f"Tahun: {self.tahun}")
        print(f"Merk: {self.merk}")
        print(f"max speed: {self.max_speed}")

supra = Toyota("Supra MK-4", 2022)
supra.info()
supra.start()
supra.stop()
